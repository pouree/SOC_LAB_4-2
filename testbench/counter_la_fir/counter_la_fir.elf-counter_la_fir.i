# 0 "counter_la_fir.c"
# 1 "/home/ubuntu/lab-caravel_fir_Grp5/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_fir.c"
# 19 "counter_la_fir.c"
...
# 155 "counter_la_fir.c"
 ...
 int Y = (*(volatile uint32_t *)0x30000084);

 if (Y == 0x2A2D)

  (*(volatile uint32_t*)0x2600000c) = (Y << 24) | 0x005A0000;
